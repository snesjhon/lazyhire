...
- Bullets should usually be medium-length, not terse and not sprawling: prefer 25-44 words when the experience database supports that level of specificity
